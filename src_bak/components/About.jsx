      ...
      <div className="max-w-5xl mx-auto">
        <h2
          className="text-4xl font-bold text-center mb-10
                     bg-gradient-to-r from-blue-200 via-emerald-300 to-green-300
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              onClick={prev}
              className="px-3 py-2 text-white hover:text-black rounded-lg ring-1 ring-white/15 hover:bg-gray-100"
